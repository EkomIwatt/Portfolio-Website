# PLACEHOLDERS — cutover gate

Temporary scaffolding content. **This file must be empty (all boxes checked) before
the Stage 5 cutover / going live.** Ekom is building the real projects after the
rebrand, then documenting each here. Nothing fabricated ships.

Search the codebase for `PLACEHOLDER` to find every marker in context.
