// REFERENCE ONLY — candidate ATMOSPHERE component for the hero.
// See ./README.md. Lightweight (SVG, no canvas). Recolor slate/neutral → crimson/navy;
// gate the animation behind prefers-reduced-motion; the letter-by-letter title animation
// is a strong fit for the hero headline. Needs shadcn <Button> (button.tsx in this folder).
"use client";
