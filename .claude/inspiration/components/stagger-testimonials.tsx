...
// See ./README.md. MUST change before use: replace fake testimonials + pravatar avatars
// with REAL certificate/proof content; already uses shadcn semantic tokens (primary/card/
// border) so it themes to crimson cleanly via CSS vars; add keyboard nav + reduced-motion.
"use client"
