...
// See ./README.md. Strongest a11y baseline of the set (arrow-key nav + prev/next buttons),
// but: uses Next.js-only `<style jsx>` (convert to CSS module / Tailwind for Astro);
// autoplay must default OFF or be pausable; replace fake quotes + Unsplash with real certs.
"use client";
      ...
      <div className="testimonial-grid">
        <div className="image-container" ref={imageContainerRef}>
          {testimonials.map((testimonial, index) => (
            <img key={testimonial.src} src={testimonial.src} alt={testimonial.name} className="testimonial-image" data-index={index} style={getImageStyle(index)} />
          ))}
        </div>
